...
const AddTaskDetails: FC<IAddTaskDetailsProps> = props => {
  ...
  const [date, setDate] = useState(dayjs(eta));
    ...
    <View style={{flex: 1}}>
      ...
      <ScrollView>
        ...
        <TaskInput
          ...
          containerStyle={styles.entryLabel}
          onChangeText={text =>
            updateTaskFormDetails(text, TaskFormFieldEnum.clientFirstName)
          }
        />
        <TaskInput
          ...
          containerStyle={styles.entryLabel}
          onChangeText={text =>
            updateTaskFormDetails(text, TaskFormFieldEnum.clientLastName)
          }
        />
        <TaskInput
          ...
          containerStyle={styles.entryLabel}
          onChangeText={text =>
            updateTaskFormDetails(text, TaskFormFieldEnum.ClientEmailAddress)
          }
        />
        <TaskInput
          ...
          containerStyle={styles.entryLabel}
          onChangeText={text =>
            updateTaskFormDetails(text, TaskFormFieldEnum.ClientPhoneNumber)
          }
        />
